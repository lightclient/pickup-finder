...
<ivy-module version="2.0" xmlns:m="http://ant.apache.org/ivy/maven">
  <info organisation="" module="android" revision="unspecified" status="integration" publication="20161020101537">
    <description/>
  </info>
  <configurations>
  ...
  <publications>
    <artifact name="android" type="aar" ext="aar" conf="archives,default"/>
    <artifact name="android" type="aar.asc" ext="asc" conf="archives,signatures"/>
    <artifact name="android" type="jar" ext="jar" conf="archives" m:classifier="sources"/>
    <artifact name="android" type="jar.asc" ext="asc" conf="archives,signatures" m:classifier="sources"/>
    <artifact name="android" type="jar" ext="jar" conf="archives" m:classifier="javadoc"/>
    <artifact name="android" type="jar.asc" ext="asc" conf="archives,signatures" m:classifier="javadoc"/>
  </publications>
  <dependencies>
    <dependency org="com.facebook.react" name="react-native" rev="+" conf="compile-&gt;default"/>
    <dependency org="com.google.android.gms" name="play-services-base" rev="9.4.0" conf="compile-&gt;default"/>
    <dependency org="com.google.android.gms" name="play-services-maps" rev="9.4.0" conf="compile-&gt;default"/>
  </dependencies>
</ivy-module>
